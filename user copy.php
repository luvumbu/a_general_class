...
?>
  ...
  <div class="alert_signal" onclick="alert_signal(this)">
    <p>
      Cliquer ici pour signaler l'article
    </p>
    <img width="50" height="50" src="https://img.icons8.com/ios/50/break--v2.png" alt="break--v2" />
  </div>
...
<script>
  function alert_signal(_this) {

    var ok = new Information("../update/alert_signal.php");
