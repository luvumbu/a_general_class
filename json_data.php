...
foreach ($id_projet as $index => $projet) {
    // Conversion ASCII et remplacement des guillemets
    $name_projet_clean = htmlspecialchars(AsciiConverter::asciiToString($name_projet[$index]), ENT_QUOTES);
    $title_projet_clean = htmlspecialchars(AsciiConverter::asciiToString($title_projet[$index]), ENT_QUOTES);
    $description_projet_clean = htmlspecialchars(AsciiConverter::asciiToString($description_projet[$index]), ENT_QUOTES);
    ...
    $associated_data[] = [
        ...
        'name_projet' => $name_projet_clean,  // Nom avec guillemets remplacés
        'statue_projet' => $statue_projet[$index],
        'title_projet' => $title_projet_clean,  // Titre avec guillemets remplacés
        'description_projet' => $description_projet_clean,  // Description avec guillemets remplacés
